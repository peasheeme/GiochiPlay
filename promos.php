...
<div class="row">
          ...
          <div class="col-xs-12 col-md-8 col-lg-4 text-xs-center text-center">
              <img src="img/2.png" alt="Paquetes"> </div>
          <div class="col-xs-12 col-md-2 col-lg-4"></div>
      </div>
      <div class="row">
                  ...
                  <div class="card z-depth-0 bordered">
                    <div class="card-header" id="headingOne">
                      <h5 class="mb-0">
                        <button class="btn btn-link text-xs-left text-left" type="button" data-toggle="collapse" data-target="#collapseOne"
                          ...
                          <div class="media">
                             <img  class=" d-flex mr-3 img-instalaciones" src="img/galaxer.png" alt="paquetes"> 
                             <div class="media-body">
                                <span class="mt-0 servicio-title mt-10">  GALAXER </span>  <i class="fas fa-angle-down rotate-icon"></i>
                             </div>
                            </div>
                        </button>
                      </h5>
                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                     ...
                     <div id="owl-promo-galaxer" class="owl-carousel margen-top2 ">
                              ...
                              <div class="owl-item"  style="padding-left: 5px ;">
                                  <img style="width: 100%;  height: auto; " src="img/promos/promo1.jpg"  alt="lazergame">
                              </div>
